...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      font-WorkSans outline-none focus:bg-bg-secondary data-[state=open]:bg-bg-secondary`,
      inset && 'pl-8',
      className,
    )}
    {...props}
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        `z-40 min-w-[8rem] overflow-hidden rounded-md border border-border-secondary
        bg-bg-primary p-1 text-text-primary shadow-md`,
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      text-sm font-WorkSans outline-none transition-colors focus:bg-bg-secondary
      focus:text-text-primary data-[disabled]:pointer-events-none data-[disabled]:opacity-50`,
      inset && 'pl-8',
      className,
    )}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-2 py-1.5 text-sm font-semibold font-WorkSans',
      inset && 'pl-8',
      className,
    )}
    {...props}
